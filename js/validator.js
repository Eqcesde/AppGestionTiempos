...
// console.log(document.querySelector('#fecha')) /*permite seleccionar clases tipo css*/
// console.log(document.querySelectorAll('#fecha')) /* permite seleccionar todo lo que tenga el item*/
